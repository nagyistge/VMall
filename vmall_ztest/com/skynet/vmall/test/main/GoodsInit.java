...
public class GoodsInit
{
	...
	{
		init_goodsclassspec("00110002", new String[]
		{ "尺码", "颜色" });
		init_goods("001100020007", new String[]
		{ "法兰米高2015夏季新款中坡跟蝴蝶结露趾女凉鞋", "欧百特凉拖鞋女夏平跟欧美新款2015羊皮软面人字拖夹趾百搭平底真皮凉拖", "少女猫2015夏季新款舒适铆钉平底女凉鞋拼色小坡跟凉拖鞋", "奥康女鞋 新款韩版真皮舒适休闲低帮鞋 平底平跟女单鞋" });
	}
	...
	public static void init_goods(String goodsclassid, String[] goodses)
	{
		...
		for (int i = 0; i < goodses.length; i++)
		{
			...
			String supgoodsid = goodsclassid + "-" + FormatKey.format(i, 4);
			sql = new StringBuffer();
