...
HYD.popbox.IconPicker = function(a) {
    ...
    g = function(a) {
        f = a ? a: f;
        var b = _.template(e, {
            data: HYD.popbox.iconimgsrc.data[f.style][f.color]
        });
    ...
    d.find("#j-useIcon").click(function(b) {
        ...
        if (0 == c.length) return HYD.hint("danger", "对不起，请选择一张小图标"),
        !1;
        ...
        a.ajax({
            ...
            success: function(d) {
                if (1 == d.status) {
                    ...
                    var e = a(_.template(Tpl.imgs, {
                        dataset: Cache.imgs
                    })),
                    i = a(d.page);
                    g.find(".j-loading").hide().end().find("ul,.j-noPic").remove().end().append(e),
                    h.empty().append(i),
                    i.filter("a:not(.disabled,.cur)").click(function() {
