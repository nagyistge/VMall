...
$(function(){
    ...
    $("a.addspec").click(function() {page_addspec()});
    $("a.addspecvalue").each(function(index){$(this).click(function() {page_addspecvalue();})});
    ...
    function page_showspecvalue()
    {
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$("a.addspecvalue").each(function(index){
					$(this).click(function() {
						page_addspecvalue();
					})
				});				
	...
	function page_addspecvalue()
	{
		...
		console.log(event);
		console.log(e);
		console.log(e.getAttribute("specclass"));
		current_specclass = e.getAttribute("specclass");
		console.log(current_specclass);
        $.jBox.show({
            title: "添加规格",
