...
<link rel="stylesheet" href="${base}/lib/bootstrap/css/bootstrap.min.css">
    ...
    <form action="${base}/finance/drawcash/browse.action" method="post" id="queryform">
        ...
        <div class="tables-searchbox">
            ...
            <input type="text" autocomplete="off" name="applytimeend" value="" placeholder="申请时间" class="input Wdate mini" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd'})">
...
<script src="${base}/page/finance/drawcash/lists.js"></script>
...
$("#tbody tr").each(function(){
	...
	$.ajax({
		type:'post',
		url:'${base}/finance/drawcashgoods/ajaxlist.action',
