...
@InjectName("appsupplierService")
@IocBean(args =
{ "refer:dao" })
public class AppSupplierService extends SkynetDaoService
{
	public AppSupplierService()
	{
		super();
		// TODO Auto-generated constructor stub
	}

	public AppSupplierService(Dao dao)
	{
		super(dao);
		// TODO Auto-generated constructor stub
	}
	...
	public List<DynamicObject> browse(Map map) throws Exception
	{
		...
		sql.append("   from t_app_supplier supplier ").append("\n");
