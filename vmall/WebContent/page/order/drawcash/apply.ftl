...
<div class="info-list">
	...
	<div class="tbl-type">
        ...
        <span class="tbl-cell"><span><input type="text" maxlength="50" class="new-input" name="openbank" id="openbank" value="${obj.drawcash.openbank}" title="开户银行" required></span></span>
    </div>
</div>
...
<div class="info pd">
	<div class="tbl-type">
        ...
        <span class="tbl-cell"><span><input type="text" maxlength="50" class="new-input" name="bankaccountno" id="bankaccountno" value="${obj.drawcash.bankaccountno}" title="银行卡号" required></span></span>
    </div>
</div>
...
<div class="info pd">
	<div class="tbl-type">
        ...
        <span class="tbl-cell"><span><input type="text" maxlength="50" class="new-input" name="bankaccountcname" id="bankaccountcname" value="${obj.drawcash.bankaccountcname}" title="账户姓名" required></span></span>
    </div>
</div>
...
<div class="tbl-type">
    ...
    <span class="tbl-cell"><span><input type="text" maxlength="50" class="new-input" name="bankaccountphone" id="bankaccountphone" value="${obj.drawcash.bankaccountphone}"></span></span>
</div>
</div>
<br/>    
