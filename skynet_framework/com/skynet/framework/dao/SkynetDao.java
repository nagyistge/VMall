...
public class SkynetDao extends NutDao
{
	...
	// SQL语句查询，用于关联查询，返回DynamicObject列表对象；
	public List<DynamicObject> queryForList(String sql, int startIndex, int endIndex) throws Exception
	{
		...
		s.setCallback(new SqlCallback()
		{
			public Object invoke(Connection conn, ResultSet rs, Sql sql) throws SQLException
			{
				List list = DyDBToolKit.packObjData(rs, fstartIndex, fendIndex);
				return list;
			}
		});
		execute(s);
	...
	public List<DynamicObject> findBy(String table, String propertyName, String value) throws Exception
	{
	...
	public List<DynamicObject> findBy(String table, Condition cnd) throws Exception
	{
	...
	// 条件查询，用于单体查询，返回DynamicObject列表对象；
	public DynamicObject locateBy(String table, String propertyName, String value) throws Exception
	{
